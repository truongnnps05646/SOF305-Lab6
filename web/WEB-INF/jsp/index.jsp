<%-- 
    Document   : index
    Created on : Apr 6, 2018, 12:54:30 PM
    Author     : zmido_000
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Tolle - Tool For Manager</title>
        <!-- plugins:css -->
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                                ...
                                <a class="dropdown-item preview-item">
                                    ...
                                    <div class="preview-item-content flex-grow">
                                        <h6 class="preview-subject ellipsis font-weight-medium">Nguyễn Minh Hiếu
                                            <span class="float-right font-weight-light small-text">3 hour ago</span>
                                        </h6>
                                        <p class="font-weight-light small-text">
                                            Check sản phẩm mới!
                                        </p>
                                ...
                                <a class="dropdown-item preview-item">
                                    ...
                                    <div class="preview-item-content flex-grow">
                                        <h6 class="preview-subject ellipsis font-weight-medium"> Quốc Trung
                                            <span class="float-right font-weight-light small-text">18 hour ago</span>
                                        </h6>
                                        <p class="font-weight-light small-text">
                                            Họp Team!
                                        </p>
                        ...
                        <li class="nav-item nav-profile">
                            <div class="nav-link">
                                ...
                                <div class="profile-name">
                                    <p class="name">Nguyễn Nhựt Trường</p>
                                    <p class="designation">Boss</p>
                                    <div class="badge badge-teal mx-auto mt-3">Offline</div>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="index.htm"><img class="menu-icon" src="images/menu_icons/01.png" alt="menu icon"><span class="menu-title">Dashboard</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.htm"><img class="menu-icon" src="images/menu_icons/04.png" alt="menu icon"><span class="menu-title">Form</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="pages/tables/basic-table.htm"><img class="menu-icon" src="images/menu_icons/06.png" alt="menu icon"><span class="menu-title">Table</span></a></li>
                        <li class="nav-item">
