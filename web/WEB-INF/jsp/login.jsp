<%-- 
    Document   : login
    Created on : Oct 2, 2017, 2:33:12 PM
    Author     : tylershelter
--%>
...
<html lang="en">
  ...
  <body class="align">
    ...
    <div class="grid">
      ...
      <form action="login_pa.htm" method="POST" class="form login">
        ...
        <p class="text--center">Not a member? <a style="color: black" href="register.jsp">Sign up now</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
